...
const Goals = () => {
  ...
  return (
    <div>
      ...
      <div className=" px-4 mx-4 py-4 lg:px-7 xl:px-7 text-[#fff] bg-[#293241] rounded-md   flex justify-center items-center text-center   xl:text-[28px] lg:text-[28px] sm:text-[23px] text-[18px] ">
      ...
      <div className="px-4 py-5">
        <div className="py-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8">
          <div className="p-5 rounded-md infPic flex items-center justify-center  bg-[#293241] drop-shadow-lg  cursor-pointer text-white  ">
            <div>
