...
function Logincomp() {
  ...
  return (
    <div className=" lg:shadow-2xl flex items-center lg:justify-between justify-center bg-white rounded-xl">
      <div className="lg:flex hidden">
        <div className=" rounded-md flex items-center justify-center px-8">
          <Player
            ...
            className="h-[400px]  xl:pt-0 xl:pb-0 lg:pt-0 lg:pb-0 sm:pt-5 sm:pb-10"
          ></Player>
        </div>
      </div>
