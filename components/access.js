...
const Access = () => {
  ...
  return (
    <div>
        ...
        <div className="p-4 w-full text-center">
          <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-12">
            <div className="h-full  w-full    infPic flex items-center justify-center  ">
              <div className="w-[250px] min-h-[60vh] md:w-[300px] lg:w-[300px] xl:w-[350px] rounded-lg bg-[#293241] drop-shadow-lg  cursor-pointer text-white ">
      ...
      <div className="rounded-md mx-4 my-5 min-h-[70vh] px-4 pt-7 bg-[#293241]">
          ...
          <div className="lg:flex lg:justify-between lg:items-center px-0">
            <div className="w-auto h-auto p-1 ">
              <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:gap-6 lg:gap-5 sm:gap-4 gap-4">
                ...
                <div className="xl:text-[26px] lg:text-[25px] sm:text-[25px] text-white text-[18px] font-semibold flex items-center justify-start text-center lg:text-left xl:text-left">
