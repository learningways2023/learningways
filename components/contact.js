      ...
      <div className="py-9 w-full rounded-md flex items-center justify-center">
        ...
        <div className="newloginContainer px-6 pb-2">
          ...
          <form
            ...
            ref={form}
            action="https://docs.google.com/forms/u/0/d/e/1FAIpQLSdaKS8uOVDARz_-zUXwFDeRymfFTl4nxspIjIIdMIstS0mdmw/formResponse"
            method="POST"
          >
            ...
            />
            <label className="text-lg font-medium py-3">Message</label>
            <textarea
