        ...
        <div class="thefront cursor-pointer flex flex-col justify-between">
          ...
          <div className="flex justify-center items-center ">
            <div className="min-h-[5vh] bg-white w-full mx-4 rounded-md">
              <div className="text-xl font-semibold flex text-center justify-center items-center py-1">
                {props.tittle}
              </div>
            </div>
          </div>
          <div className="flex justify-between text-white px-2">
            <div className="text-lg font-semibold">{props.date}</div>
            <div className="text-lg font-semibold">{props.loc}</div>
