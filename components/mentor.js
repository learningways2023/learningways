  ...
  return (
    <div>
      <div class=" bg-[#085464] border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-5">
          <a href="#">
            <h5 class="mb-2 xl:text-[42px] lg:text-[32px] sm:text-[32px] text-[20px] font-bold tracking-tight text-white text-center">
              John Doe, Senior Software Engineer
            </h5>
          </a>
          <p class="mb-3 font-normal xl:text-[26px] lg:text-[25px] sm:text-[25px] text-[18px] text-white text-center">
