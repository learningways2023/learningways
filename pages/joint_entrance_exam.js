...
const JointEntranceExam = () => {
  const classes =
    "border-2 border-[#085464] text-[#085464] text-base   w-full h-full rounded-md focus:ring-[#085464] focus:border-[#085464]  block py-2.5 lg:px-9 xl:px-9 px-9 ";
  ...
  return (
    <div>
      ...
      <div className="m-4 min-h-[100vh] bg-[#085464]">
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4">
          <div className="w-full h-full flex-row justify-center items-center">
            <div className="text-[#ffff] p-4 pt-9   flex justify-center  items-center text-center xl:text-[42px] lg:text-[32px] sm:text-[32px] text-[20px] ">
      ...
      <div className="text-[#085464] p-4 flex justify-center  items-center text-center xl:text-[42px] lg:text-[34px] sm:text-[32px] text-[22px] font-semibold mt-10 ">
        Categories
      </div>
      <div className="px-4 py-8  grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 pt-9 gap-6 ">
        <div className="w-full h-full flex justify-center items-center">
          <div className="w-[150px] min-h-[70px] lg:w-[200px] xl:h-[90px]  border border-1 hover:text-white border-[#085464] focus:bg-[#085464] focus:text-white rounded-lg bg-white hover:bg-[#085464]  text-[#085464] cursor-pointer text-center flex justify-center items-center font-semibold">
            {" "}
            JEE SYLLABUS
          </div>
        </div>
        <div className="w-full h-full flex justify-center items-center">
          <div className="w-[150px] min-h-[70px] lg:w-[200px] xl:h-[90px]  border border-1 hover:text-white border-[#085464] rounded-lg bg-white hover:bg-[#085464]  text-[#085464] cursor-pointer text-center flex justify-center items-center font-semibold">
            {" "}
            JEE NOTIFICATION
          </div>
        </div>
      ...
      <div className="min-h-[50vh]  px-4 py-8  flex-wrap justify-center items-center ">
        <div className="">
      ...
      <div className="px-4 py-8 min-h-[60vh] ">
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4">
          <div className="flex  items-center">
            <div className="">
              <div className="text-[#c47993] p-2    flex  items-center text-center xl:text-[28px] lg:text-[28px] sm:text-[23px] text-[18px] ">
                <Image src={bullet1} width={40} height={40} className="mr-3" />
                Interactive Classes
              </div>
              <div className="text-[#c47993] p-2    flex   items-center text-left xl:text-[28px] lg:text-[28px] sm:text-[23px] text-[18px] ">
                <Image src={bullet1} width={40} height={40} className="mr-3" />
                Comprehensive Study Material
              </div>
            </div>
      ...
      <div className="px-4 py-9 lg:px-7 xl:px-7">
        ...
        <div className=" p-2 py-2    flex   items-center text-left xl:text-[28px] lg:text-[28px] sm:text-[23px] text-[18px] ">
          <Image src={bullet1} width={40} height={40} className="mr-3" />
      ...
      <div className="text-[#085464] px-4 py-9 lg:px-7 xl:px-7  flex justify-center  items-center text-center xl:text-[42px] lg:text-[34px] sm:text-[32px] text-[22px] font-semibold mt-10 ">
        What you get?
      </div>
      ...
      <div className=" px-4  lg:px-7 xl:px-7 text-[#c47993]    flex justify-center items-center text-center   xl:text-[28px] lg:text-[28px] sm:text-[23px] text-[18px] ">
      ...
      <div className="text-[#085464] px-4 py-9 lg:px-7 xl:px-7   flex justify-start  items-center text-center xl:text-[42px] lg:text-[34px] sm:text-[32px] text-[22px] font-semibold mt-10 ">
        Download Here
      </div>
      ...
      <div className="text-[#085464] p-4 pt-9   flex justify-center  items-center text-center xl:text-[42px] lg:text-[34px] sm:text-[32px] text-[22px] font-semibold mt-10 ">
        Previous Year Questions
      </div>
      <div className=" p-4 text-[#c47993]    flex justify-center items-center text-center   xl:text-[28px] lg:text-[28px] sm:text-[23px] text-[18px] ">
      ...
      <div className="text-[#085464] px-4 py-9 lg:px-7 xl:px-7  flex justify-center  items-center text-center xl:text-[42px] lg:text-[34px] sm:text-[32px] text-[22px] font-semibold mt-10 lg:text-left xl:text-left">
        Mentorship
      </div>
      <div className="text-[#c47993] p-4 pb-9    xl:text-[35px] lg:text-[25px] sm:text-[25px] text-[20px] text-center ">
      ...
      <div className="px-4 py-9 lg:px-7 xl:px-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
        <div className="sm:p-6 p-4 rounded-lg flex  items-center justify-center  infPic infp  ">
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-2">
            <div className="rounded-md flex items-center justify-center">
              <div className="w-auto h-auto bg-[#085464] flex justify-center items-center high1">
                <span className="text-white   lg:text-xl md:text-lg p-2 text-sm text-center">
            ...
            <div className="rounded-md flex items-center justify-center">
              <div className="w-auto h-auto flex justify-center items-center">
                <span className=" text-[#085464] lg:text-lg md:text-lg text-[14px] text-center   py-4">
            ...
            <div className="rounded-md flex items-center justify-center">
              ...
              <div className="pl-5">
                ...
                <div className="sm:text-[14px] text-[13px]   text-gray-500">
            ...
            <div className="py-7 flex justify-center items-center pb-4">
              <div className="getstarted  gt xl:text-[20px] lg:text-[18px] text-[#fff]  py-2 px-8  rounded-md text-center">
                <button className=" ">Schedule a session with John</button>
              </div>
            </div>
          </div>
        </div>
        <div className="sm:p-6 p-4 rounded-lg flex  items-center justify-center infp  infPic drop-shadow-lg">
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-2">
            <div className="rounded-md flex items-center justify-center">
              <div className="w-auto h-auto bg-[#085464] flex justify-center items-center high1">
                <span className="text-white   lg:text-xl md:text-lg p-2 text-sm text-center">
        ...
        <div className="sm:p-6 p-4 rounded-lg flex  items-center justify-center infp infPic drop-shadow-lg">
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-2">
            <div className="rounded-md flex items-center justify-center">
              <div className="w-auto h-auto bg-[#085464] flex justify-center items-center high1">
                <span className="text-white   lg:text-xl md:text-lg text-sm p-2 text-center">
                  "John helped me improve my coding skills and gave me valuable
                  insights on how to advance in my career." - Jane Smith, Junior
                  Developer
                </span>
      ...
      <div className="px-4 py-9 lg:px-7 xl:px-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8">
        <div className="p-5 rounded-md infPic flex items-center justify-center bg-[#085464] drop-shadow-lg  cursor-pointer text-white wwd">
          <div>
            ...
            <div className="px-3  text-[20px]   flex justify-center items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4">
          <div className="w-full h-full flex justify-center items-start">
            <div className=" flex-row justify-center items-center">
              <div className="text-[#c47993] p-4 pt-9   flex justify-center  items-center text-center xl:text-[42px] lg:text-[34px] sm:text-[32px] text-[22px] font-semibold mt-10 ">
                Partner with us for a successful JEE journey.
              </div>
              <div className="text-[#085464] p-2    flex   items-center text-center xl:text-[28px] lg:text-[28px] sm:text-[23px] text-[18px] ">
