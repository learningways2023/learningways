...
const NationalEntranceEligiblityTest = () => {
  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4">
          <div className="flex  items-center">
            <div className="py-8">
              ...
              <div className=" p-2 py-2  text-[#ffff] flex   items-center text-left xl:text-[28px] lg:text-[28px] sm:text-[23px] text-[18px] ">
                <Image src={bullet} width={40} height={40} className="mr-3" />
                Access to a community of NEET aspirants for peer-to-peer
      ...
      <div className="px-4 mx-4 rounded-md py-9 lg:px-7 xl:px-7 font-semibold grid grid-cols-1 md:grid-cols-2 cardbg1 lg:grid-cols-3 xl:grid-cols-3 gap-8">
        <div className="p-5 rounded-md infPic flex items-center justify-center card-col drop-shadow-lg  cursor-pointer text-white wwd">
          <div>
