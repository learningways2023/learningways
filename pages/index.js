          ...
          <div className="grid grid-cols-1 md:grid-col-1 lg:grid-cols-2 xl:grid-cols-2 gap-6">
            <div className="flex flex-col justify-center items-center p-4">
              <div className="xl:text-[26px]  lg:text-[25px] sm:text-[25px] text-[18px] font-semibold flex items-center justify-start text-center text-white">
                Join our community groups to connect with like-minded
                individuals, engage in meaningful conversations, and learn from
                others. Our experienced community managers ensure respectful and
                constructive discussions. Expand your network and make new
                friends today!
              </div>
              <div className="pt-10">
                <div
