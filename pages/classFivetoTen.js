    ...
    <div>
      ...
      <div className=" min-h-[70vh] mx-4 mt-8 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-md ">
        <div className="px-4 pt-9 lg:px-7 xl:px-7 grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-5">
          <div className="py-5 w-full flex justify-center items-center">
            <div className=" w-11/12 card-col border border-1 border-gray-300 rounded-lg drop-shadow-2xl cursor-pointer text-black hover:bg-gradient-to-r from-blue-500 to-cyan-500  flex-row p-3 hover:text-white wwd1 justify-center items-center text-center text-xl">
              <div className="flex justify-center items-center text-center py-4 ">
                In publishing and graphic design, Lorem ipsum is a placeholder
                text commonly used to demonstrate the visual form of a document
                or a typeface without relying on meaningful content. Lorem ipsum
